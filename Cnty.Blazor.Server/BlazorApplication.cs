...
namespace Cnty.Blazor.Server {
    public partial class CntyBlazorApplication : BlazorApplication {
        public CntyBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void CntyBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
