...
namespace Cnty.Module.BusinessObjects {
	...
	[XafDisplayName("Công nghệ được ứng dụng trong chăn nuôi")]
	[NavigationItem(R.MenuDanhmuc)]
	[DefaultListViewOptions(MasterDetailMode.ListViewOnly, true, NewItemRowPosition.Top)]
	public class CongNgheDuocApDung : BaseObject {
		public CongNgheDuocApDung(Session session) : base(session) { }
